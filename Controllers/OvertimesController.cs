...
namespace MvcOvertime.Controllers
{
    public class OvertimesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Day,NumberOfHours,StartTime,DtStartTime")] Overtime overtime)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Day,NumberOfHours,StartTime,DtStartTime")] Overtime overtime)
        {
            if (id != overtime.Id)
            {
                return NotFound();
